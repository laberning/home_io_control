...
| [0040](0040-low-power-start-preamble-follows-the-wake-belief.md) | A low-power device's start preamble follows its wake belief | *Proposed.* Tries ordered by per-device evidence (short first when believed awake, wake-up preamble in every plan; single-try exchanges keep it); amends 0029; `low_power_wake_belief` switch |
