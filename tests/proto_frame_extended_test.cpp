...
TEST(ProtoFrame, CommandNameKnownCommands) {
  ...
  EXPECT_STREQ(command_name(CMD_PRIORITY_LEVEL_REQ), "PRIORITY_LEVEL_REQ");
  EXPECT_STREQ(command_name(CMD_PRIORITY_LEVEL_RESP), "PRIORITY_LEVEL_RESP");
  ...
  EXPECT_STREQ(command_name(CMD_NODE_VERIFY_REQ), "NODE_VERIFY_REQ");
  EXPECT_STREQ(command_name(CMD_NODE_VERIFY_RESP), "NODE_VERIFY_RESP");
